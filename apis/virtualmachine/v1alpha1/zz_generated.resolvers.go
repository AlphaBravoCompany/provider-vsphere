...
func (mg *VSphereVirtualDisk) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.Datastore),
		Extract:      resource.ExtractParamPath("Name", true),
		Reference:    mg.Spec.InitProvider.DatastoreRef,
		Selector:     mg.Spec.InitProvider.DatastoreSelector,
		To: reference.To{
			List:    &v1alpha11.VSphereVmfsDatastoreList{},
			Managed: &v1alpha11.VSphereVmfsDatastore{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.Datastore")
	}
	mg.Spec.InitProvider.Datastore = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.DatastoreRef = rsp.ResolvedReference
