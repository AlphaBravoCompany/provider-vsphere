...
func (tr *VSphereGuestOsCustomization) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"spec[*].linux_options[*].script_text": "spec.forProvider.spec[*].linuxOptions[*].scriptTextSecretRef", "spec[*].windows_options[*].admin_password": "spec.forProvider.spec[*].windowsOptions[*].adminPasswordSecretRef", "spec[*].windows_options[*].domain_admin_password": "spec.forProvider.spec[*].windowsOptions[*].domainAdminPasswordSecretRef", "spec[*].windows_options[*].product_key": "spec.forProvider.spec[*].windowsOptions[*].productKeySecretRef", "spec[*].windows_sysprep_text": "spec.forProvider.spec[*].windowsSysprepTextSecretRef"}
}
