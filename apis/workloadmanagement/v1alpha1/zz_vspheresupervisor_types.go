...
type VSphereSupervisor struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.mainNtp) || (has(self.initProvider) && has(self.initProvider.mainNtp))",message="spec.forProvider.mainNtp is a required parameter"
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.workerNtp) || (has(self.initProvider) && has(self.initProvider.workerNtp))",message="spec.forProvider.workerNtp is a required parameter"
