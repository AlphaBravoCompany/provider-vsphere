...
func Configure(p *config.Provider) {
	...
	p.AddResourceConfigurator("vsphere_virtual_disk", func(r *config.Resource) {
		...
		r.References["datacenter"] = config.Reference{
			Type:      "github.com/kirillinda/provider-vsphere/inventory/v1alpha1.VSphereDatacenter",
			Extractor: `github.com/upbound/upjet/pkg/resource.ExtractParamPath("name", true)`,
		}
		r.References["datastore"] = config.Reference{
			Type:      "github.com/kirillinda/provider-vsphere/inventory/v1alpha1.VSphereVmfsDatastore",
